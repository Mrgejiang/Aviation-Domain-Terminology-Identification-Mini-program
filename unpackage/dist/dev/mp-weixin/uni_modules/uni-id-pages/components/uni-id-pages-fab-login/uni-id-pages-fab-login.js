    ...
    async login_before(type, navigateBack = true, options = {}) {
      ...
      if (type == "univerify") {
        ...
        let onButtonsClickFn = async (res) => {
          common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:352", "点击了第三方登录，provider：", res, res.provider, this.univerifyStyle.buttons.list);
        ...
        return univerifyManager.login({
          ...
          fail(err) {
            common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:402", err);
      ...
      common_vendor.index.login({
        ...
        fail: async (err) => {
          common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:447", err);
          common_vendor.index.hideLoading();
        }
      });
    },
    login(params, type) {
      common_vendor.index.__f__("log", "at uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue:454", { params, type });
