...
const _sfc_main = {
  ...
  methods: {
    ...
    async showRewardedVideoAd() {
      ...
      if (res && res.length == 0) {
        let userId = common_vendor.er.getCurrentUserInfo().uid;
        if (!userId) {
        ...
        uni_modules_uniSignIn_utils_ad.AD.show({
          ...
          if (res2 && res2.isEnded) {
            common_vendor.index.__f__("log", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:103", "onClose " + res2.isEnded);
            let i = 0;
            ...
            common_vendor.index.__f__("log", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:127", "onClose " + res2.isEnded);
            common_vendor.index.showToast({
              title: "播放中途退出,签到失败！",
              icon: "error",
              duration: 5e3
          ...
          common_vendor.index.__f__("log", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:137", err);
          common_vendor.index.showToast({
            title: err.errMsg,
            icon: "none"
          });
    ...
    async open() {
      ...
      try {
        ...
        if (res && res.length == 0) {
          ...
          common_vendor.index.__f__("log", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:154", res2);
          common_vendor.index.hideLoading();
        ...
        common_vendor.index.hideLoading();
        common_vendor.index.__f__("error", "at uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue:174", e);
      }
    },
    closeMe(e) {
  ...
  return {
    ...
    d: common_vendor.f($data.weekdays, (item, index, i0) => {
      return common_vendor.e({
        ...
        e: "806617ee-2-" + i0 + ",806617ee-0",
        f: common_vendor.p({
          color: "#FFFFFF",
          type: "closeempty"
        })
      } : {
        g: "806617ee-3-" + i0 + ",806617ee-0",
        h: common_vendor.p({
          type: "checkmarkempty",
          color: "#FFFFFF"
        })
    ...
    g: common_vendor.sr("popup", "806617ee-0"),
    h: common_vendor.p({
      type: "center"
    })
  };
