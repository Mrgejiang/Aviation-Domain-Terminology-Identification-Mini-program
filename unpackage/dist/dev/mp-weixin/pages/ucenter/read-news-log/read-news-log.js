...
const _sfc_main = {
  ...
  onLoad() {
    ...
    common_vendor.index.__f__("log", "at pages/ucenter/read-news-log/read-news-log.vue:52", typeof readNewsLogIds, readNewsLogIds);
    ...
    a: common_vendor.w(({
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            a: item.poster,
            b: common_vendor.t(item.cnDetails.name || "中 无名称"),
            c: common_vendor.t(item.usDetails.name || "美 无名称"),
            d: common_vendor.t(item.euDetails.name || "欧 无名称"),
            e: "07cdb9a0-3-" + i0 + "-" + i1 + "," + ("07cdb9a0-2-" + i0 + "-" + i1),
            f: common_vendor.p({
            ...
            g: index,
            h: common_vendor.o(($event) => $options.handleItemClick(item), index),
            i: "07cdb9a0-2-" + i0 + "-" + i1 + "," + ("07cdb9a0-1-" + i0)
          };
        }),
        b: "07cdb9a0-1-" + i0 + ",07cdb9a0-0",
        c: "07cdb9a0-4-" + i0 + ",07cdb9a0-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
