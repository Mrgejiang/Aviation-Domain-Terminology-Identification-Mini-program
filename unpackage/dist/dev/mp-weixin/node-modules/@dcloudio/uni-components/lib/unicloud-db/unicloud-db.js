...
const _sfc_main = {
  name: "UniClouddb",
  setup(props) {
    const dataListRef = props.ssrKey ? props.getone ? common_vendor.shallowSsrRef(void 0, props.ssrKey) : common_vendor.ssrRef([], props.ssrKey) : props.getone ? common_vendor.shallowSsrRef(void 0, "JGkR/P8lwgh06E9AFA023g==") : common_vendor.ssrRef([], "EQfuMC6Zv8WLs1fS5j7nXg==");
  ...
  methods: {
    ...
    _execRemove(id, action, success, fail, complete, needConfirm, needLoading, loadingTitle) {
      ...
      const db = common_vendor.er.database(this.spaceInfo);
