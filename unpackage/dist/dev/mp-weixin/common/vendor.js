...
function initRuntimeSocketService() {
  const hosts = "192.168.192.1,192.168.144.1,10.8.81.150,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_FDMtE7";
...
const pages = [
  ...
  {
    path: "pages/ucenter/favorite/favorite",
    style: {
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      iconPath: "static/tabs/agent_default.png",
      selectedIconPath: "static/tabs/agent_selected.png"
    },
    {
      text: "我的",
...
const b = true, E = "mp-weixin", P = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = E, A = T('{"address":["127.0.0.1","192.168.192.1","192.168.144.1","10.8.81.150"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/HBuilderX.4.45.2025010502/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"kite","spaceId":"mp-003d93a9-efde-40df-a943-25e82e419019","clientSecret":"05+uOli3WpelTsQKFXoCkA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__55B1F26";
} catch (e2) {
    ...
    }
    {
      ...
      if (!index.__stat_uniCloud_space) {
        if (space && Object.keys(space).length !== 0) {
          ...
          index.__stat_uniCloud_space = er.init(spaceData);
        } else {
